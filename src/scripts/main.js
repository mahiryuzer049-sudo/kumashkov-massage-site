import { initScannerV4 } from "./modules/scanner-v4.js";
...
const scannerRoot = document.getElementById("scanner") || document.getElementById("scanner-section");
const scannerInstance = scannerRoot
  ? initScannerV4({ root: scannerRoot, phoneDigits: sitePhone, whatsappLoadingText, reducedEffects })
  : null;
if (scannerInstance) {
  window.__openZone = (zone) => scannerInstance.openZone(zone);
  window.__scannerDebug = scannerInstance.debug;
}
